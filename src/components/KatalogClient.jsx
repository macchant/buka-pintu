...
export default function KatalogClient({ apiUrl }) {
  ...
  // Show Coming Soon only if absolutely no books
  if (!loading && books.length === 0) {
    return (
      <section className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white relative overflow-hidden">
        <div className="absolute inset-0 opacity-5">
          <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-orange-500 rounded-full blur-3xl"></div>
          <div className="absolute bottom-1/4 right-1/4 w-80 h-80 bg-green-500 rounded-full blur-3xl"></div>
        </div>
        <div className="absolute top-20 left-10 text-6xl opacity-10 animate-float"><i className="fas fa-book"></i></div>
        <div className="absolute top-32 right-20 text-5xl opacity-10 animate-float" style={{animationDelay: '0.5s'}}><i className="fas fa-book-open"></i></div>
        <div className="absolute bottom-40 left-20 text-4xl opacity-10 animate-float" style={{animationDelay: '1s'}}><i className="fas fa-bookmark"></i></div>
        <div className="absolute bottom-20 right-10 text-6xl opacity-10 animate-float" style={{animationDelay: '1.5s'}}><i className="fas fa-graduation-cap"></i></div>

        <div className="relative max-w-4xl mx-auto px-6 text-center">
          <div className="w-24 h-24 bg-gradient-to-br from-orange-500 to-green-600 rounded-3xl flex items-center justify-center mx-auto mb-8 shadow-2xl shadow-orange-500/30 animate-float">
            <i className="fas fa-book-open text-white text-4xl"></i>
          </div>
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-orange-500/20 border border-orange-500/30 rounded-full text-sm font-semibold text-orange-300 mb-6">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-display font-extrabold mb-6 leading-tight">
            Katalog Buku<br/>
            <span className="bg-gradient-to-r from-orange-400 to-green-400 bg-clip-text text-transparent">Sedang Disiapkan</span>
          </h1>
          <p className="text-gray-400 text-lg md:text-xl max-w-2xl mx-auto mb-10 leading-relaxed">
            Kami sedang bekerja keras untuk menghadirkan koleksi buku digital yang lengkap dan berkualitas.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="/" className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-gradient-to-r from-orange-500 to-green-600 text-white font-bold rounded-full hover:shadow-lg hover:-translate-y-1 transition-all">
              <i className="fas fa-home"></i>Kembali ke Beranda
            </a>
            <a href="/admin" className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-white/10 border border-white/20 text-white font-semibold rounded-full hover:bg-white/20 transition-all">
